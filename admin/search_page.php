<div class="post-popular ">
    ...
    <form action="index.php" method="get" class="form-inline">
            ...
            <input type="hidden" name="index" value="search_page">
    ...
    <div class="content row ">
      ...
      <?php
        ...
        $data_ = $conn->query("SELECT * FROM tb_post WHERE judul LiKE '%$_GET[cari]%' AND status='publis'");
      ...
      ?>
        ...
        <div class="cover">
            <div class="middle">
              <a href="tambah.php?id=<?php echo $cerpen['id'] ?>"><div class="text">+ Ke Daftar Baca</div></a>
              <a href="index.php?page=detail&id=<?php echo $cerpen['id'] ?>"><div class="text">Baca Sekarang</div></a>
            </div>
        </div>
      </div>
      <?php
      ...
      ?>
       ...
       <div class="container pt-md-3" >
        ...
        <div class="row mt-md-2">
          ...
          <div class="col-md-6">
            <a href="beranda.php?beranda=fantasi" style="color: black; text-decoration: none;">
              <div class="shadow p-3 pt-5 pb-5 mb-5 mb-5 bg-white rounded">Fantasi</div>
            </a>
          </div>
          <div class="col-md-6">
            <a href="beranda.php?beranda=roman" style="color: black; text-decoration: none;">
              <div class="shadow p-3 pt-5 pb-5 mb-5 mb-5 bg-white rounded">Roman</div>
            </a>
          </div>
        </div>
      </div>
